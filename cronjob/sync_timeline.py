...
if __name__ == "__main__":
    ...
    print commands.getoutput("../env/bin/python /home/work/proj/thepast/jobs.py -t old -c 100 -n 1")
    ...
    print commands.getoutput("../env/bin/python /home/work/proj/thepast/jobs.py -t new -c 100 -n 1")
